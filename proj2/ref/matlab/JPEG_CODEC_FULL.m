...
%      
     c=[];
     for i=1:2:numel(run_level_pairs) % loop through run_level_pairs
%          % Case 1 & Cae 2
...
%              % Case 3: End of Block decoding
             ...
             number_of_trailing_zeros= 256-mod(numel(c),256);
