module Top_FIR_filter (
	...
	rflp256x12mx4 FOLDED_INPUT_MEM (.NWRT(1'b1), .NCE(1'b0), .CLK(clk20), .DIN(), .CA(addr_in[1:0]), .RA(addr_in[7:2]), .DO(x_in_folded));
	rflp256x22mx4 FOLDED_OUTPUT_MEM (.NWRT(1'b0), .NCE(1'b0), .CLK(clk20), .DIN(y_out_folded), .CA(addr_out[1:0]), .RA(addr_out[7:2]), .DO());
