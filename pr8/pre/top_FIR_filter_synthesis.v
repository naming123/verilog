module top_FIR_filter_synthesis (
	output reg [26-1:0] y_out_trans_d,
	output reg [8-1:0] addr_in_d, addr_out_d,
	input [16-1:0] x_in_trans_q,
	input clk, reset, 
	...
	trans_FIR_filter_low_cost TRANS_FIR_FILTER (.trans_out(y_out_trans), .c0(c0), .c1(c1), .c2(c2), .c3(c3), .c4(c4), .c5(c5), .in(x_in_trans), .clk(clk), .reset(reset));
