...
module sti_FIR_filter;
	...
	initial $readmemh("C:/Users/osm13/Desktop/26-1/VLSI/osm/pr8/cur/input_vector_hex.txt", FIR.TRANS_INPUT_MEM.array);  //check the path of memory rocation (module instance)

	integer i=0;	
	initial
	begin		
		$readmemh("C:/Users/osm13/Desktop/26-1/VLSI/osm/pr8/cur/output_vector_hex_round_after_sum.txt", sig_mat);
		begin
			#(110);
			for (i=0; i<252; i=i+1)
			begin
