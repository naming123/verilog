module multiplier_rca_DFF (
	...
	multiplier_rca MUL_28_28_RCA (.mul(mul_d), .a(a_q), .b(b_q));
...
module multiplier_rca (
	...
	FA_28bit VMA00 (.sum(mul[55:28]), .a({1'b0, pp_sum[26]}), .b(c_out[26]), .c_in(1'b0));
...
module FA_28bit (
	...
	FA_1bit FA22 (.sum(sum[22]), .c_out(c_out[22]), .a(a[22]), .b(b[22]), .c_in(c_out[21]));
	FA_1bit FA23 (.sum(sum[23]), .c_out(c_out[23]), .a(a[23]), .b(b[23]), .c_in(c_out[22]));
	FA_1bit FA24 (.sum(sum[24]), .c_out(c_out[24]), .a(a[24]), .b(b[24]), .c_in(c_out[23]));
	FA_1bit FA25 (.sum(sum[25]), .c_out(c_out[25]), .a(a[25]), .b(b[25]), .c_in(c_out[24]));
	FA_1bit FA26 (.sum(sum[26]), .c_out(c_out[26]), .a(a[26]), .b(b[26]), .c_in(c_out[25]));
	FA_1bit FA27 (.sum(sum[27]), .c_out(c_out[27]), .a(a[27]), .b(b[27]), .c_in(c_out[26]));
