module carry_select_adder_28b_2stage (
	output [29-1:0] sum,
	input [28-1:0] a, b,
	input c_in, clk, rstn
);
	...
	wire [20-1:0] sum_d0_pipe, sum_d1_pipe;
	wire [5-1:0] c0_pipe, c1_pipe;
	wire c_in_q, c_pipe;
	...
	// DFF_1bit STAGE_0_DFF1(.q(c[0]), .d(c_pipe[0]), .clk(clk), .rstn(rstn));
	...
	DFF_4bit STAGE_5_DFF0(.q(sum_d0_pipe[15:12]), .d(sum_d0[19:16]), .clk(clk), .rstn(rstn));
	DFF_4bit STAGE_5_DFF1(.q(sum_d1_pipe[15:12]), .d(sum_d1[19:16]), .clk(clk), .rstn(rstn));
	DFF_1bit STAGE_5_DFF2(.q(c0_pipe[3]), .d(c0[4]), .clk(clk), .rstn(rstn));
	DFF_1bit STAGE_5_DFF3(.q(c1_pipe[3]), .d(c1[4]), .clk(clk), .rstn(rstn));

    mux_2to1_4b STAGE_5_M0(.out(sum_d[23:20]), .i0(sum_d0_pipe[15:12]), .i1(sum_d1_pipe[15:12]), .sel(c[4]));
    mux_2to1_1b STAGE_5_M1(.out(c[5]), .i0(c0_pipe[3]), .i1(c1_pipe[3]), .sel(c[4]));
	...
	DFF_4bit STAGE_6_DFF0(.q(sum_d0_pipe[19:16]), .d(sum_d0[23:20]), .clk(clk), .rstn(rstn));
	DFF_4bit STAGE_6_DFF1(.q(sum_d1_pipe[19:16]), .d(sum_d1[23:20]), .clk(clk), .rstn(rstn));
	DFF_1bit STAGE_6_DFF2(.q(c0_pipe[4]), .d(c0[5]), .clk(clk), .rstn(rstn));
	DFF_1bit STAGE_6_DFF3(.q(c1_pipe[4]), .d(c1[5]), .clk(clk), .rstn(rstn));

    mux_2to1_4b STAGE_6_M0(.out(sum_d[27:24]), .i0(sum_d0_pipe[19:16]), .i1(sum_d1_pipe[19:16]), .sel(c[5]));
    mux_2to1_1b STAGE_6_M1(.out(sum_d[28]), .i0(c0_pipe[4]), .i1(c1_pipe[4]), .sel(c[5]));

    DFF_29bit DFF3(.q(sum), .d(sum_d), .clk(clk), .rstn(rstn));
