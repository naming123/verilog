...
module rflp4096x8mx4(
    ...
    wire [8-1:0] temp_array_0 = array[0];
    wire [8-1:0] temp_array_1 = array[1];
    wire [8-1:0] temp_array_2 = array[2];
    wire [8-1:0] temp_array_3 = array[3];
    wire [8-1:0] temp_array_4 = array[4];
    wire [8-1:0] temp_array_5 = array[5];
    wire [8-1:0] temp_array_6 = array[6];
    wire [8-1:0] temp_array_7 = array[7];
